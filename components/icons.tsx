...
export function IcoPlus({ size, className, ...props }: IcoProps) {
  return (
    <svg {...stroke(size, className, props)}>
      <path d="M5 12h14" />
      <path d="M12 5v14" />
...
export function IcoPencil({ size, className, ...props }: IcoProps) {
  return (
    <svg {...stroke(size, className, props)}>
...
export function IcoTrash({ size, className, ...props }: IcoProps) {
  return (
    <svg {...stroke(size, className, props)}>
      <path d="M3 6h18" />
...
export function IcoSave({ size, className, ...props }: IcoProps) {
  return (
    <svg {...stroke(size, className, props)}>
