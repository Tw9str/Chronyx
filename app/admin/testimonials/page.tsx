    ...
    <AdminShell>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          >
            <IcoPlus className="h-4 w-4" /> Add Testimonial
          </button>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-2 rounded-2xl border border-dashed border-edge py-16 text-center">
            <IcoQuote className="h-8 w-8 text-ink-fade" />
                ...
                >
                  <div className="p-4">
                    ...
                    <div className="mt-4 flex items-center gap-2 border-t border-edge pt-3">
                      ...
                      >
                        {t.enabled ? (
                          <IcoToggleRight className="h-3 w-3 text-secondary" />
                        ) : (
                          <IcoToggleLeft className="h-3 w-3" />
                        )}
